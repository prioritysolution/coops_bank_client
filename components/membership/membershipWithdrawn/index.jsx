  ...
  return (
    <div className="w-full h-full flex justify-between p-2 lg:p-5 bg-[#fefefe] rounded-lg ">
      <div className=" h-full flex flex-col justify-start items-center border-primary rounded-lg border-[2px] p-2 lg:p-5 w-full gap-5 overflow-hidden">
        <h3 className="text-2xl font-semibold ">Membership Withdrawn</h3>
                ...
                <div className="w-full h-full flex flex-col border border-primary rounded-lg p-5 gap-5">
                  ...
                  <div className="w-full grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-x-10 gap-y-3">
                    <FormField
                      ...
                      name="date"
                      render={({ field }) => (
                        <FormItem className="flex flex-col gap-[6px] py-1">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Dividend Balance</FormLabel>
                          <FormControl>
                            <Input
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Withdraw Reason</FormLabel>
                          <FormControl>
                            <Textarea
                    ...
                    <div className="w-full flex flex-col lg:flex-row gap-10">
                      <div className="w-full ">
                        ...
                        <CashDenomTable
                          ...
                          amountTobePaid={
                            Number(form.getValues("shareBalance")) +
                            Number(form.getValues("divBalance"))
                          }
                          outTable={false}
                        />
                      </div>
