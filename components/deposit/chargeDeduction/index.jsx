  ...
  return (
    <div className="w-full h-full flex justify-between p-2 lg:p-5 bg-[#fefefe] rounded-lg ">
      <div className=" h-full flex flex-col justify-start items-center border-primary rounded-lg border-[2px] p-2 lg:p-5 w-full gap-5 overflow-hidden">
        <h3 className="text-2xl font-semibold ">Charge Deduction</h3>
          ...
          <Form {...form}>
            ...
            >
              <div className="w-full h-full flex flex-col border border-primary rounded-lg p-5 gap-5">
                <div className="w-full grid grid-cols-1 xl:grid-cols-2  gap-x-10 gap-y-3 items-end">
                  <FormField
                    control={form.control}
                    name="payoutOn"
                    render={({ field }) => (
                      <FormItem className="flex flex-col lg:flex-row items-center space-y-0 gap-x-10 gap-y-5   border border-input rounded-md px-3 pr-10 py-3 w-full h-fit">
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        >
                          <FormControl>
                            <SelectTrigger>
                              <SelectValue placeholder="Select charge on" />
                            </SelectTrigger>
                          </FormControl>
                          <SelectContent>
                            {/* {payoutModeData &&
                              ...
                              <FormControl>
                                ...
                                >
                                  {field.value ? (
                                    ...
                                    <span>Pick transanction date</span>
                                  )}
