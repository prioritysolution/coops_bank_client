...
const PostOfficeTable = ({ data, handleEditData }) => {
  ...
  return (
    <div className="w-full  flex flex-col items-center lg:items-end pt-4">
      <div className="flex justify-end items-center py-4">
        <Input
          placeholder="Filter post office name..."
          value={table.getColumn("Post_Off_Name")?.getFilterValue() ?? ""}
          onChange={(event) =>
            table.getColumn("Post_Off_Name")?.setFilterValue(event.target.value)
          }
