...
const MemberSearchTable = ({ data, handleSelectData }) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        return (
          <div className="text-left px-5">{row.getValue("Member_No")}</div>
        );
      },
    },
    {
      ...
      cell: ({ row }) => {
        return <div className="text-left">{row.getValue("CIF_No")}</div>;
      },
    },
    {
    ...
    },
    {
      ...
      cell: ({ row }) => {
        return <div className="text-left">{row.getValue("Relation_Name")}</div>;
      },
    },
    {
      accessorKey: "Address",
